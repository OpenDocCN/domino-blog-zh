...
> 原文:[https://www . dominodatalab . com/blog/manual-feature-engineering](https://www.dominodatalab.com/blog/manual-feature-engineering)
...
![Domino Data Lab Enterprise MLOPs workspace](../Images/535c4ccd490ac6972c5c9b0cd6157fbd.png)
...
至少这更具体一点，但是我们用来转换这些的固定值是什么呢？嗯，这来自转换温度的公式:![formula for converting temperature](../Images/755415c717d1be123472ed7c6e565d56.png)

一点代数就把它变成了![formula for converting temperature](../Images/559e92edd9d0afe80be0627a434c4f5d.png)
...
![plotting temperature in a line graph](../Images/2dbcf862bcef76233fbeb0295f6d80ad.png)
...
![temperature data scaled using sklearn StandardScaler](../Images/4b980a462c3c19ebd9be62dcdbb8d0ec.png)

这里，度量单位不是华氏温度或摄氏温度:它是标准差的单位。标准差告诉我们数据的分布。我们的数据越分散，标准差就越大。我们标准化后还是线性规模。这可能会令人惊讶。公式如下:

![scaled formula](../Images/5f052f5ec95ee908d5f31c24b15f0dcb.png)
...
![Various types of scaling plotted on a scatter plot graph](../Images/5c27149fe07cf01d949c588857f60db6.png)
...
![Iris dataset](../Images/e0516790d9e9e4f793d6e1a2a7c69fae.png)
...
![distribution plot of sepal length from iris dataset](../Images/e0011532468a68560d713da50dd8d5e3.png)
...
![mean of sepal length in iris dataset](../Images/9ded606b77fb40680550e006f22deb9d.png)
...
![pandas DataFrame of data points in iris dataset](../Images/51dfc93b82317f2325e7e8cc25ae44d3.png)
...
![merged pandas DataFrame of data points in iris dataset](../Images/8e9fb58ec16048542f8eaf8a02a53ce1.png)
...
![feature engineering of iris dataset using patsy](../Images/89d446a14215fbab933833a222777c43.png)
...
![feature engineering of iris dataset using patsy](../Images/18a2e98e1cbec4562b3a5489b1d8f1f0.png)
...
![cost of cats and dogs dataset](../Images/7f2c0030a1cdc16b56c9df4233a19d10.png)
...
![modeling of cats and dog data](../Images/1716266426b529f39dc2d109fe6da798.png)
...
![patsy used on cats and dogs dataset](../Images/2c415b05f8d37fbb0c94cf7a42635aa7.png)
...
![Intercept of cats and dogs data using sklearn model](../Images/78605b0a0a2e640b9e15b1622f987192.png)
...
![statsmodel of cats and dogs dataset](../Images/764bb7981a703da884d4cad536bc24c4.png)
...
![Predictions from skmodel of cats and dogs data](../Images/7b9343308fc37f03fc3e38237769f1f2.png)
...
![display of cat and dog data](../Images/8fb034133bfaf526f971181e4653897f.png)
...
![sum of column](../Images/11fadd381a8330fd77dcb4c6479dcf8b.png)
...
![simple table of data to use for xor](../Images/f9c4e46bf5abdc1fc570780fe38dd60b.png)
...
![scatterplot](../Images/1d8fc14fd8eff8088a27454b66ae6afd.png)
...
![xor dataframe](../Images/a181ad6a4c502930d40c932256ea2850.png)
...
![Numerical features with sklearn](../Images/d5942db260891c9be34367adbe60d831.png)
...
![patsy formula used on iris dataset](../Images/ab6beff78b4b0b938321ef11a0462f25.png)
...
![Combining smaller and larger petal data and discretizing](../Images/8565456d35188f1172fe8f5d7b1a7756.png)
...
![patsy dmatrix of iris dataset](../Images/100599c2cbeb605b7f1c32731610d12c.png)

![patsy dmatrix of iris dataset](../Images/062911fa5c910ab38054c8afb94ca254.png)
...
![display(design_df.iloc[:,[0]])](../Images/98f6959fe4fbc1768d875bd86ff56e92.png)

![display(design_df.iloc[:,[1]])](../Images/f248870a2290939e1308d2600b0f5c79.png)

![display(design_df.iloc[:,[2]])](../Images/b00884ff39c4bb344fe9d7d0e4f5498e.png)
...
![training data for iris dataset](../Images/3f8d1a81b69e20730902d5b5eaf9616d.png)
...
![testing data for iris dataset](../Images/2119c4db393ea6e94aa156093cf3f271.png)
...
![plots of variable d1 and d2](../Images/f7f8086077b8f9bc8a5e3ac21c905c4e.png)
...
![d1 and d2 distribution plotted](../Images/8240a4b1b1d003ddceabc6ac6ca67671.png)
...
![line graph and histogram of variable x_sq and d2](../Images/2018c6399e173c0041f81a7fb5604884.png)
...
![line graphs of variable d1 and d2](../Images/a8e0cc44b78c2dacfa9ad17fc4baa291.png)
...
![distribution of d1 and d2 plotted](../Images/80fd11444911d614238dac061d85e508.png)
...
![regression and histogram of x and log_d2](../Images/097fb384d3152d305feaefcd6066afcc.png)
