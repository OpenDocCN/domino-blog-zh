...
*<small>![comparison example of two people arrested for petty theft](img/875437e699a1b875963787af33c661b7.png)</small>*
...
*<sup>Domino 数据科学领域笔记提供数据科学研究、趋势、技术等亮点，支持数据科学家和数据科学领导者加快工作或职业发展。如果你对本博客系列中涉及的数据科学工作感兴趣，请给我们发电子邮件至 writeforus@dominodatalab.com。</sup>*