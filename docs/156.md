...
*<small>[迪安](mailto:dean@anyscale.io) [Wampler](https://twitter.com/deanwampler) 提供了 Ray 的概要，这是一个用于将 Python 系统从单机扩展到大型集群的开源系统。如果您对其他见解感兴趣，请注册参加[即将举行的射线峰会](https://events.linuxfoundation.org/ray-summit/)。</small>*
