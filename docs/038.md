...
> 原文:[https://www . dominodatalab . com/blog/trust-in-lime-local-可解释-模型不可知-解释](https://www.dominodatalab.com/blog/trust-in-lime-local-interpretable-model-agnostic-explanations)
...
*<sup>Domino 数据实验室提供数据科学研究的亮点、趋势、技术等，支持数据科学家和数据科学领导者加快他们的工作或职业发展。如果你对我们博客中报道的你的数据科学工作感兴趣，请发邮件到 writeforus@dominodatalab.com 给我们。</sup>T3】*